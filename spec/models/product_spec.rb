...
RSpec.describe Product, type: :model do
  describe 'Validations' do
    ...
    context 'a new initialized product' do
      it 'should save with all required fields filled in' do
        category.save
        p category
        product.save
          p @product
      ...
      it 'should fail to save without a name field' do
        category.save
        product.name = nil
        product.save
      ...
      it 'should fail to save without a price field' do
        category.save
      ...
      it 'should fail to save without a quantity field' do
        category.save
      ...
      it 'should fail to save without a category id specified' do
        category.save
